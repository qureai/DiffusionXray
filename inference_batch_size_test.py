...
from cheff.sr.sampler import CheffSRModel_PLMS

print("check : imports")

device = 'cuda'
sr_path = '/raid/data_transfer/data/chexray-diffusion/cheff_sr_fine.pt'
input_folder = '/raid/data_transfer/data/CheX-ray14/test_lr_ddpm_2/folder_8'  # Specify the path to the folder containing input images
output_folder = '/raid/data_transfer/data/CheX-ray14/test_lr_ddpm_sr_chexraybase'
batch_size = 65
